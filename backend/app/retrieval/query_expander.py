...
MULTILINGUAL_GLOSSARY = {
    ...
    "नवीनता": "novelty Section 2 1 j",
    "आविष्कारक कदम": "inventive step Section 2 1 ja",
    "आविष्कार": "invention",
    "पूर्व कला": "prior art",
    "संयोजन": "combination synergistic admixture Section 3 e",
    "जैव विविधता": "biological diversity NBA Section 6 Form III",
    # Tamil terms
    "காப்புரிமை": "patent",
    ...
    "新規性": "novelty Article 29 1",
    "進歩性": "inventive step Article 29 2",
    "先行技術": "prior art state of the art",
    "特許要件": "patentability requirements",
    "食薬区分": "food drug classification Circular 429",
    "機能性表示食品": "foods with function claims FFC CAA framework",
    "存続期間": "patent term duration Article 67 PTE extension",
    "特許期間延長": "patent term extension PTE Article 67",
    "存続期間延長": "patent term extension PTE Article 67",
    "商標法第3条": "Trademark Act Section 3 generic plant name",
    "商標登録": "trademark registration Article 3",
    "配合": "formulation composition",
    "相乗効果": "synergistic effect",
    "請求項": "patent claims",
    "地理的表示": "geographical indication GI",
    # German terms (for EP/EPC inquiries)
    "erfinderische Tätigkeit": "inventive step EPC Article 56",
    "erfinderischen Tätigkeit": "inventive step EPC Article 56",
    "erfinderisch": "inventive step EPC Article 56",
    "Neuheit": "novelty EPC Article 54",
    "Stand der Technik": "prior art state of the art",
    "Patentfähigkeit": "patentability",
    "Patentansprüche": "patent claims",
    "Patentanspruch": "patent claim",
    "Pflanzenextrakte": "plant extracts botanical formulation",
    "Pflanzenextrakts": "plant extract botanical formulation",
    "Pflanzenextrakt": "plant extract botanical formulation",
    "pflanzliche Arzneimittel": "traditional herbal medicinal products THMPD Directive 2004/24/EC",
    "traditionelle pflanzliche Arzneimittel": "traditional herbal medicinal products THMPD",
    "EPÜ": "EPC European Patent Convention",
    "EPA": "EPO European Patent Office",
    "Europäisches Patentamt": "European Patent Office EPO",
}
